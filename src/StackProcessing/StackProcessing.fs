...
let rescaleIntensity<'T when 'T: equality> = StackImageFunctions.rescaleIntensity<'T>
let intensityWindow<'T when 'T: equality> = StackImageFunctions.intensityWindow<'T>
let normalize<'T when 'T: equality> = StackImageFunctions.normalize<'T>
let shiftScale<'T when 'T: equality> = StackImageFunctions.shiftScale<'T>
let invertIntensity<'T when 'T: equality> = StackImageFunctions.invertIntensity<'T>
...
let binaryThinning = StackImageFunctions.binaryThinning
...
let labelShapeStatistics<'T when 'T: equality> = StackImageFunctions.labelShapeStatistics<'T>
let labelIntensityStatistics<'L,'T when 'L: equality and 'T: equality> = StackImageFunctions.labelIntensityStatistics<'L,'T>
let labelOverlapMeasures<'T when 'T: equality> = StackImageFunctions.labelOverlapMeasures<'T>
