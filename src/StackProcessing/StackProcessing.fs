...
let serialKeypoints2D<'T when 'T: equality> = StackSerialSections.serialKeypoints2D<'T>
let serialKeypointTranslationManifest = StackSerialSections.serialKeypointTranslationManifest
let serialImageTranslationManifest<'T when 'T: equality> = StackSerialSections.serialImageTranslationManifest<'T>
let serialApplyManifest<'T when 'T: equality> = StackSerialSections.serialApplyManifest<'T>
