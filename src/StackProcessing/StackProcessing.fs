...
let windowToSlab<'T when 'T: equality> = StackImageFunctions.windowToSlab<'T>
let slabToWindow<'T when 'T: equality> = StackImageFunctions.slabToWindow<'T>
let slabSkipTakeM<'T when 'T: equality> = StackImageFunctions.slabSkipTakeM<'T>
