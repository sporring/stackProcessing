...
type PipelineNodeState(definition: Function, parameters: PipelineParameterViewModel list) =
    ...
    member this.NodeBackground =
        ...
        elif definition.Id = "ComputeStats" || definition.Id = "ComponentTranslationTable" || definition.Id = "ImHistogramData" || definition.Id = "Histogram" || definition.Id = "Stats" then
