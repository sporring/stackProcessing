...
let domainSuite =
    testList "Studio.Graph domain" [
        ...
        testCase "port compatibility supports Any and Number wildcards" <| fun _ ->
            ...
            Expect.isTrue (PortType.canConnect (Custom "NumberStats") (Custom "Record")) "Number statistics should connect to the generic Expand record input."
