...
let catalogSuite =
    testList "Studio.Graph catalog" [
        ...
        testCase "geometry measurement catalog uses mesh and scalar reducer ports" <| fun _ ->
            ...
            Expect.containsAll ids ["ToVectorImage"; "AppendVectorElement"; "VectorElement"; "VectorRange"; "Vector3ToColor"; "ColorToVector3"; "VectorMapElements"; "VectorDot"; "VectorCross3D"; "VectorAngleTo"; "Gradient"; "StructureTensor"; "SymmetricTensorEigensystem"; "SymmetricTensorEigenvector"] "Vector-valued image composition and pixelwise vector operations should be available in Studio."
        ...
        testCase "vector image catalog uses vector-valued ports" <| fun _ ->
            ...
            let vector3ToColor = BuiltInCatalog.find "Vector3ToColor"
            ...
            let symmetricTensorEigensystem = BuiltInCatalog.find "SymmetricTensorEigensystem"
            let symmetricTensorEigenvector = BuiltInCatalog.find "SymmetricTensorEigenvector"
            ...
            Expect.equal vector3ToColor.Inputs.[0].Type vectorType "vector3ToColor should consume a vector-valued image."
            Expect.equal vector3ToColor.Outputs.[0].Type colorType "vector3ToColor should emit a color image."
            ...
            Expect.equal symmetricTensorEigensystem.Inputs.[0].Type (PortType.Custom "VectorImageFloat32") "symmetricTensorEigensystem should consume Float32 vector-valued tensor chunks."
            Expect.equal symmetricTensorEigensystem.Outputs.[0].Type (PortType.Custom "VectorImageFloat32") "symmetricTensorEigensystem should expose one Float32 vectorized 3x4 eigensystem output."
            Expect.equal symmetricTensorEigenvector.Inputs.[0].Type (PortType.Custom "VectorImageFloat32") "symmetricTensorEigenvector should consume Float32 vector-valued tensor chunks."
            Expect.equal symmetricTensorEigenvector.Outputs.[0].Type (PortType.Custom "VectorImageFloat32") "symmetricTensorEigenvector should expose one Float32 three-component vector output."
