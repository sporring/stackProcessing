...
let catalogSuite =
    testList "Studio.Graph catalog" [
        testCase "catalog exposes expected generic functions" <| fun _ ->
            ...
            Expect.containsAll ids ["Scalar"; "FileDirectory"; "Read"; "ReadSlab"; "ReadZarrSlab"; "Write"; "WriteInSlabs"; "WriteZarr"; "GetStackInfo"; "GetChunkInfo"; "GetZarrInfo"; "ImageOpImage"; "ComputeStats"; "Chart"] "Important Studio functions should be in the palette catalog."
