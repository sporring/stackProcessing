...
let catalogSuite =
    testList "Studio.Graph catalog" [
        testCase "catalog exposes expected generic functions" <| fun _ ->
            ...
            Expect.containsAll ids ["Clamp"; "RescaleIntensity"; "IntensityWindow"; "Normalize"; "ShiftScale"; "InvertIntensity"; "Median"; "Bilateral"; "GradientMagnitude"; "SobelEdge"; "Laplacian"; "ImageComparison"; "MaskLogic"; "NotMask"; "Mask"] "The high-value SimpleITK filter families should be available in Studio."
            ...
            Expect.containsAll ids ["BinaryContour"; "BinaryThinning"; "BinaryMedian"; "BinaryOpeningByReconstruction"; "BinaryClosingByReconstruction"; "BinaryReconstructionByDilation"; "BinaryReconstructionByErosion"; "VotingBinaryHoleFilling"; "LabelShapeStatistics"; "LabelIntensityStatistics"; "LabelOverlapMeasures"; "LabelContour"; "ChangeLabel"] "Extra binary morphology and label analysis filters should be available in Studio."
