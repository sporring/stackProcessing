...
let catalogSuite =
    testList "Studio.Graph catalog" [
        testCase "catalog exposes expected generic functions" <| fun _ ->
            ...
            Expect.containsAll ids ["Scalar"; "FileDirectory"; "Read"; "ReadRandom"; "ReadRange"; "ReadSlab"; "ReadZarrSlab"; "ReadNexusSlab"; "ReadPointSet"; "Write"; "WriteInSlabs"; "WriteZarr"; "WriteNexus"; "WriteMesh"; "WritePointSet"; "GetStackInfo"; "GetChunkInfo"; "GetZarrInfo"; "GetNexusInfo"; "Resize"; "Resample"; "CreatePadding"; "Crop"; "MarchingCubes"; "DogKeypoints"; "StreamConnectedObjects"; "PaintObjects"; "PaintObjectsCropped"; "ImageOpImage"; "ComputeStats"; "Quantiles"; "Chart"] "Important Studio functions should be in the palette catalog."
            ...
            Expect.containsAll ids ["BinaryContour"; "BinaryMedian"; "BinaryOpeningByReconstruction"; "BinaryClosingByReconstruction"; "BinaryReconstructionByDilation"; "BinaryReconstructionByErosion"; "VotingBinaryHoleFilling"; "LabelContour"; "ChangeLabel"] "Extra binary morphology and label analysis filters should be available in Studio."
